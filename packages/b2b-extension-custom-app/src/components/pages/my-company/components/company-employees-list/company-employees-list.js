...
import EmployeesViewLayout from '../../../employees/components/employees-view-layout';
...
const getColumns = memoize(visibleColumnsOfView => {
  ...
  return {
    ...
    available: columnDefinitions,
  };
});

export class CompanyEmployeesList extends React.PureComponent {
  static displayName = 'CompanyEmployeesList';
  ...
  generateSearchQuery = (activeView, customerGroupId) => ({
    ...activeView,
    filters: {
      ...activeView.filters,
      'customerGroup.id': [
