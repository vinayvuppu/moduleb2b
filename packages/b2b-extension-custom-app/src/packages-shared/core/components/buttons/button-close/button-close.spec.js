...
describe('callbacks', () => {
  ...
  describe('when hovering the icon', () => {
    ...
    it('should set the green color for the icon on hovering', () => {
      expect(wrapper.find('CloseIcon')).toHaveProp('color', 'primary');
    });
  });
  ...
  describe('when no hovering the icon', () => {
    ...
    it('should set the green color for the icon on hovering', () => {
      expect(wrapper.find('CloseIcon')).toHaveProp('color', 'solid');
    });
  });
});
