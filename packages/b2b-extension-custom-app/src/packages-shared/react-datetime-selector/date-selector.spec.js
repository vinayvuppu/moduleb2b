  ...
  describe('render correct list of years / months options', () => {
    describe('year', () => {
      ...
      it('should render reverse list of years options', () => {
        // Year
        const selectYear = wrapper.find(SelectInput).at(0 /* year */);
    ...
    describe('month (en)', () => {
      ...
      it('should render list of months (en)', () => {
        const selectMonth = wrapper.find(SelectInput).at(1 /* month */);
        // Month (en)
  ...
  describe('render correct list of days options based on the selected month', () => {
    describe('31 days', () => {
      ...
      it('should render list of 31 days', () => {
        const selectDay = wrapper.find(SelectInput).at(2 /* day */);
        // January: 1 - 31
        ...
        expect(selectDay.prop('options').map(o => o.value)).toEqual(result);
      });
      ...
      describe('change to another month with 31 days', () => {
        ...
        it('should render list of 31 days', () => {
          const selectDay2 = wrapper.find(SelectInput).at(2 /* day */);
          // May: 1 - 31
          ...
          expect(selectDay2.prop('options').map(o => o.label)).toEqual(result);
        });
    ...
    describe('29 days', () => {
      ...
      it('should render list of 29 days', () => {
        ...
        expect(selectDay.prop('options').map(o => o.label)).toEqual(result);
      });
      it('should pass correct selected value', () => {
        const selectDay = wrapper.find(SelectInput).at(2 /* day */);
...
describe('callbacks', () => {
  ...
  describe('trigger onChange only when all 3 values are selected', () => {
    ...
    describe('when selecting year selector control', () => {
      beforeEach(() => {
        const selectYear = wrapper.find(SelectInput).at(0 /* year */);
        selectYear.prop('onChange')({ target: { value: 2016 } });
      });
    ...
    describe('when selecting month selector control', () => {
      beforeEach(() => {
        ...
        const selectMonth = wrapper.find(SelectInput).at(1 /* month */);
        selectMonth.prop('onChange')({ target: { value: 3 } });
      });
    ...
    describe('when selecting day selector control', () => {
      beforeEach(() => {
        ...
        const selectDay = wrapper.find(SelectInput).at(2 /* day */);
        selectDay.prop('onChange')({ target: { value: 15 } });
      });
